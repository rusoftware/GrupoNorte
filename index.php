...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/es_ES/sdk.js#xfbml=1&appId=306086316240295&version=v2.0";
...
<div id="wrapper">
        ...
        <div class="md-slide-items md-slider" id="md-slider-1" data-thumb-width="105" data-thumb-height="70">
			<div class="md-slide-item slide-0" data-timeout="6000">
				...
				<div class="md-objects">
					...
					<div class="md-object" data-x="495" data-y="0" data-width="612" data-height="365" data-start="1800" data-stop="7500" data-easein="fadeInRight" data-easeout="keep" style=""><img src="./_material/GN.jpg" alt="Search Money for Your Creative Ideas" width="612" height="365" /></div>
				</div>
			</div>
			<div class="md-slide-item slide-1" data-timeout="6000">
				<div class="md-mainimg"><img src="_material/sal-ud.jpg" alt=""></div>
				<div class="md-objects">
			...
			<div class="md-slide-item slide-2" data-timeout="4000">
				<div class="md-mainimg"><img src="./_material/GN.jpg" alt=""></div>
				<div class="md-objects">
        ...
        <div class="container_12 clearfix">
            <div class="grid_4 left-lst-category">
                <div class="wrap-lst-category">
                    <h3 class="title-welcome rs">Bienvenidos a Grupo Norte</h3>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque tristique sem sed neque vulputate, a condimentum metus varius. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl erat, gravida eu orci a, posuere condimentum magna. Nam facilisis lectus id mauris molestie aliquet. Nullam at magna libero. Nam iaculis urna velit, vitae blandit sem pulvinar non.</p>
                    <!--
            ...
            <div class="grid_8 marked-category">
                <div class="wrap-title clearfix">
                    <h2 class="title-mark rs">Novedades: <span class="fc-orange">Feb 2015</span></h2>
                    <a href="category.html" class="count-project be-fc-orange">Ver todas las novedades</a>
                </div>
                <div class="box-marked-project project-short">
                    <div class="top-project-info">
                        <div class="content-info-short clearfix">
                            <a href="#" class="thumb-img">
                                <img src="./_material/reunion.jpg" alt="$TITLE">
                            </a>
                            <div class="wrap-short-detail">
                                <h3 class="rs acticle-title"><a class="be-fc-orange" href="project.html">Reunión Mensual Febrero 2015</a></h3>
                                ...
                                <p class="rs title-description">El GN de empresarios llevó a cabo su reunión mensual de febrero. En el marco de una notable concurrencia se presentó una propuesta de seguridad y convivencia para el barrio y se anunciaron los ambiciosos proyectos para este año. Notable reunión.</p>
                            </div>
                    ...
                    <div class="bottom-project-info clearfix">
                        <p class="pull-right" style="padding-right:20px;"><a href=""><i class="fa fa-external-link"></i> LEER</a></p>
                        <!--
    ...
    <div class="home-popular-project">
        <div class="container_12">
            <div class="grid_12 wrap-title">
                <h2 class="common-title">Algunos Proyectos</h2>
                <a class="be-fc-orange" href="proyectos.html">View all</a>
            </div>
            <div class="clear"></div>
                ...
                <div class="grid_3">
                    <div class="project-short sml-thumb">
                        <div class="top-project-info">
                            <div class="content-info-short clearfix">
                                <a href="#" class="thumb-img">
                                    <img src="./images/ex/SalUd.jpg" alt="$TITLE">
                                </a>
                                <div class="wrap-short-detail">
                                    <h3 class="rs acticle-title"><a class="be-fc-orange" href="project.html"><span class="strike">SAL</span>UD</a></h3>
                ...
                <div class="grid_3">
                    <div class="project-short sml-thumb">
                        <div class="top-project-info">
                            <div class="content-info-short clearfix">
                                <a href="#" class="thumb-img">
                                    <img src="./images/ex/cartel.jpg" alt="$TITLE">
                                </a>
                                <div class="wrap-short-detail">
                                    <h3 class="rs acticle-title"><a class="be-fc-orange" href="project.html">Nuestras calles</a></h3>
                                    <p class="rs tiny-desc">by <a href="profile.html" class="fw-b fc-gray be-fc-orange">John Doe</a></p>
                                    <p class="rs title-description">Iniciativa a través del Presupuesto Participativo con la participación de alumnos y docentes de distintas escuelas.</p>
                                    <p class="rs project-location">
                                        <i class="icon iLocation"></i>
                                        New York, NY
                                    </p>
                ...
                <div class="grid_3">
                    <div class="project-short sml-thumb">
                        <div class="top-project-info">
                            <div class="content-info-short clearfix">
                                <a href="#" class="thumb-img">
                                    <img src="images/ex/GN-wood.jpg" alt="$TITLE">
                                </a>
                                <div class="wrap-short-detail">
                ...
                <div class="grid_3">
                    <div class="project-short sml-thumb">
                        <div class="top-project-info">
                            <div class="content-info-short clearfix">
                                <a href="#" class="thumb-img">
                                    <img src="images/ex/GN-silver.jpg" alt="$TITLE">
                                </a>
                                <div class="wrap-short-detail">
                                    <h3 class="rs acticle-title"><a class="be-fc-orange" href="project.html">Project title</a></h3>
                                    <p class="rs tiny-desc">by <a href="profile.html" class="fw-b fc-gray be-fc-orange">John Doe</a></p>
    ...
    <div class="home-discover-friends">
        <div class="container_12">
            <div class="fb-like" data-href="https://www.facebook.com/pages/Grupo-Norte/144545678921281" data-width="960" data-layout="standard" data-action="like" data-show-faces="true" data-share="false"></div>
            <!--
