...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="97%">
  ...
  <tr>
    <td bgcolor="#3a3c40" height="32%" align="center" valign="middle">
      <table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="#DC9137">
          <td style="BORDER: #000000 1px solid" colspan="3" height="15"><font size="-7">&nbsp;</font></td>
        </tr>
        <tr bgcolor="#D3D3D3" valign="middle">
          <td style="BORDER-LEFT: #000000 1px solid" class="Verdana11" height="40" width="100" align="center">
            &nbsp;&nbsp;<?= $txt['Usuario']?>: </td>
          ...
          <td style="BORDER-RIGHT: #000000 1px solid" height="40" width="100" align="center">&nbsp;
          </td>
        </tr>
        <tr bgcolor="#D3D3D3" valign="middle">
          <td style="BORDER-BOTTOM: #000000 1px solid; BORDER-LEFT: #000000 1px solid" class="Verdana11" height="40" width="100" align="center">
            &nbsp;&nbsp;<?= $txt['Clave']?>: </td>
          <td style="BORDER-BOTTOM: #000000 1px solid" width="100" height="40" align="center">
            <input type="password" name="Clave" size="10" maxlength="25" class="Verdana11" value="<?= fSacarBarras($Clave)?>">
          </td>
          <td style="BORDER-BOTTOM: #000000 1px solid; BORDER-RIGHT: #000000 1px solid" width="100" height="40" align="center">
        ...
        <tr bgcolor="#D3D3D3" align="center" valign="middle">
          <td colspan="3" style="BORDER: #000000 1px solid" class="Verdana11" height="20"><img src="Imagenes/imgAlerta.gif" width="11" height="11" align="absmiddle">&nbsp;<?= $Mensaje?></td>
        </tr>
        <? } ?>
      </table>
    </td>
