...
$cSql = "SELECT NwsEdicTitulo, NwsEdicSaludoHTML, NwsEdicSaludoText, NwsEdicEnvio FROM NwsEdicion WHERE NwsEdicCodigo=" . $_REQUEST["Codigo"] ;
$nResultado = mysql_query ($cSql) or fErrorSQL($conf["EstadoSitio"], "<br /><br /><b>Error en la consulta:</b><br />" . $cSql . "<br /><br /><b>Tipo de error:</b><br />" . mysql_error() . "<br />");
$aRegistro  = mysql_fetch_array($nResultado);
...
$cContDinHTML  = $aRegistro["NwsEdicSaludoHTML"] ;         // Contenido HTML del mail
$cContDinTexto = $aRegistro["NwsEdicSaludoText"] ;         // Contenido Texto del mail
