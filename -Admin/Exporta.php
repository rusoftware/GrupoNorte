...
$cSql = "SELECT * FROM sysMasInfo WHERE ModNombre='" . $_SESSION["gblModulo"] . "' AND MInPosicion>1 ORDER BY MInPosicion";
$nResultado = mysql_query ($cSql) or fErrorSQL($conf["EstadoSitio"], "<br /><br /><b>Error en la consulta:</b><br />" . $cSql . "<br /><br /><b>Tipo de error:</b><br />" . mysql_error() . "<br />");
while ($aRegistro = mysql_fetch_array($nResultado)) {
...
$cSql = "SELECT * FROM sysFrom WHERE ModNombre='" . $_SESSION["gblModulo"] . "'";
$nResultado = mysql_query ($cSql) or fErrorSQL($conf["EstadoSitio"], "<br /><br /><b>Error en la consulta:</b><br />" . $cSql . "<br /><br /><b>Tipo de error:</b><br />" . mysql_error() . "<br />");
$aRegistro = mysql_fetch_array($nResultado);
$cnfConsulta .= "FROM ";
...
$cSql = "SELECT * FROM sysJoin WHERE ModNombre='" . $_SESSION["gblModulo"] . "'";
$nResultado = mysql_query ($cSql) or fErrorSQL($conf["EstadoSitio"], "<br /><br /><b>Error en la consulta:</b><br />" . $cSql . "<br /><br /><b>Tipo de error:</b><br />" . mysql_error() . "<br />");
while ($aRegistro = mysql_fetch_array($nResultado)) {
...
$cSql = "SELECT * FROM sysWhere WHERE ModNombre='" . $_SESSION["gblModulo"] . "'";
$nResultado = mysql_query ($cSql) or fErrorSQL($conf["EstadoSitio"], "<br /><br /><b>Error en la consulta:</b><br />" . $cSql . "<br /><br /><b>Tipo de error:</b><br />" . mysql_error() . "<br />");
$aRegistro = mysql_fetch_array($nResultado);
...
if ($_GET["Tipo"]=="W") {     /* Formato para documentos Word ('.doc') */
  ...
  while ($aFila = mysql_fetch_row($nResultExp)) {
    ...
    for ($nColumna=0; $nColumna<mysql_num_fields($nResultExp);$nColumna++) {
      ...
      // Valor del campo
      $cRegistro .= (isset($aFila[$nColumna])?$aFila[$nColumna]:"NULL") . "\n" ;
    }
    echo("----------------------------------------------------\n");
    echo($cRegistro);
  }
